...
import Snippet from "../components/Snippet/Revealable";
...
function Home() {
  return (
    <main>
      ...
      <Snippet buttonText="Reveal Variables">
      ...
      <Snippet buttonText="Reveal Conditionals">
        <Code className="code-snippet" theme="dracula" lang="py">
          {SECOND_SNIPPET}
        </Code>
      </Snippet>
      ...
      <Snippet buttonText="Reveal Functions">
        <Code className="code-snippet" theme="dracula" lang="py">
          {THIRD_SNIPPET}
        </Code>
      </Snippet>
